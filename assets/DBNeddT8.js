...
const _sfc_main$A = {
  ...
  mounted() {
    __vitePreload(async () => {
      const { default: clickOutSide } = await import("./BbBfUbH8.js").then((n) => n.i);
